(function Stage(armlib){
	/**
	 * Создает экземпляр Stage.
	 *
	 * @constructor
	 * @param {object} O
	 * @param {string} O.name      Имя слоя.
	 * @param {string} O.container Идентификатор DOM-элемента, являющегося хранилищем для слоя.
	 * @param {number} O.width     Ширина слоя.
	 * @param {number} O.height    Высота слоя.
	 * @this {armlib.class.stage}
	...
	armlib.extend("armlib.class.stage",Stage);
})(armlib)
