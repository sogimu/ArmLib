...
(function primitive(armlib, lib) {
  var Primitive = lib.Class({Extend:armlib._class.VisualObj, Statics:{_type:["Primitive", ""], _fill:"#00FF00", _stroke:"#00aa00", _oldX:0, _oldY:0, _oldWidth:0, _oldHeight:0, _oldLandscape:null}, Methods:{_begin:function() {
    ...
    this._oldX = x < 0 ? 0 : x;
    this._oldY = y < 0 ? 0 : y;
    this._oldWidth = width <= 0 ? 1 : width;
    this._oldHeight = height <= 0 ? 1 : height;
...
(function layer(armlib, lib) {
  var Layer = lib.Class({Initialize:function(O) {
    ...
    this._init();
    return this
  }, Statics:{_type:["Layer", "", ""], _name:1E3 * Math.random(), _runStatus:false, _context:null, _layer:null, _owner:null, _container:null, _canvas:null, _width:500, _height:500, _fps:60, _zindex:0, _updating:false, _changeList:[], _list:[], _onEachFrame:null, _cancelAnimationFrame:null, _request:null, _armlib:armlib, _lib:lib}, Methods:{run:function() {
    this.stop();
    this._begin();
    var step = function(O) {
      return function() {
      ...
      if(window.mozRequestAnimationFrame) {
        ...
        if(window.requestAnimationFrame) {
          ...
          if(window.msRequestAnimationFrame) {
            ...
            var fps = this.fps;
            _onEachFrame = function(cb) {
              this._request = setInterval(cb, 1E3 / fps)
            }
          }
        }
      }
